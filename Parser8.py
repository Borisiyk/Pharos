...
def going_on_start_pages():
    next_btn = wait.until(EC.element_to_be_clickable(
        (By.XPATH, "/html/body/div[2]/section/div/div/table/thead/tr[1]/td/div/div[3]/ul/li[6]/a")))
...
def level_8():
    ...
    time.sleep(1)
    sort_by_risk_level = driver.find_element(By.XPATH, "/html/body/div[2]/section/div/div/table/thead/tr[1]/td/div/div[3]/div/div[1]")
    sort_by_risk_level.click()
    sort_by_risk_level8 = driver.find_element(By.XPATH,"/ html / body / div[7] / div[2] / div / div / div[9] / div / span")
    sort_by_risk_level8.click()
    print("Pressed: Risk Level_8 ")
    time.sleep(2)


def parsed_page():
    with open(file_address + '/data/1_log8.txt', 'a') as file:
